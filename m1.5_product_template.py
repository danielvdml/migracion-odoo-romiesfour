...
file_name = conn1.download_json("product.template",fields,
                                            limit=0,
...
#Cargar Nuevos
conn2.load_json("product.template",file_name,transform=transform,dup=True,field_name=True,threads=20)